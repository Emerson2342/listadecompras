...
export const ListaGeralContextProvider = ({ children }) => {
  ...
  const [listaGeral, setListaGeral] = useState([
    { id: 1, tipo: "Acougue", produto: "Picanha", valor: 48.99, quantidade: 1 },
    {
      id: 2,
      tipo: "Acougue",
    ...
    { id: 5, tipo: "Acougue", produto: "Músculo", valor: 20.99, quantidade: 1 },
    { id: 6, tipo: "Acougue", produto: "Bife", valor: 23.99, quantidade: 1 },
    { id: 7, tipo: "Acougue", produto: "Acém", valor: 23.99, quantidade: 1 },
    {
      id: 8,
      tipo: "Acougue",
    ...
    { id: 12, tipo: "Acougue", produto: "Asinha", valor: 15.0, quantidade: 1 },
    {
      id: 13,
      tipo: "Acougue",
    ...
    { id: 16, tipo: "Acougue", produto: "Bacon", valor: 23.99, quantidade: 1 },
    {
      id: 17,
      tipo: "Limpeza",
    ...
    { id: 66, tipo: "Mercearia", produto: "Arroz", valor: 0, quantidade: 1 },
    { id: 67, tipo: "Mercearia", produto: "Feijão", valor: 0, quantidade: 1 },
    { id: 68, tipo: "Mercearia", produto: "Macarrão", valor: 0, quantidade: 1 },
    { id: 69, tipo: "Mercearia", produto: "Açúcar", valor: 0, quantidade: 1 },
    { id: 70, tipo: "Mercearia", produto: "Leite", valor: 0, quantidade: 1 },
    { id: 71, tipo: "Mercearia", produto: "Café", valor: 0, quantidade: 1 },
    { id: 72, tipo: "Mercearia", produto: "Óleo", valor: 0, quantidade: 1 },
    { id: 73, tipo: "Mercearia", produto: "Ovos", valor: 0, quantidade: 1 },
    { id: 74, tipo: "Mercearia", produto: "Polvilho", valor: 0, quantidade: 1 },
    { id: 75, tipo: "Mercearia", produto: "Maizena", valor: 0, quantidade: 1 },
    { id: 76, tipo: "Mercearia", produto: "Café", valor: 0, quantidade: 1 },
    {
      id: 77,
      tipo: "Mercearia",
    ...
    { id: 79, tipo: "Mercearia", produto: "Toddy", valor: 0, quantidade: 1 },
    { id: 80, tipo: "Mercearia", produto: "Maionese", valor: 0, quantidade: 1 },
    { id: 81, tipo: "Mercearia", produto: "Catchup", valor: 0, quantidade: 1 },
    { id: 82, tipo: "Mercearia", produto: "Queijo ", valor: 0, quantidade: 1 },
    { id: 83, tipo: "Mercearia", produto: "Presunto", valor: 0, quantidade: 1 },
    { id: 84, tipo: "Mercearia", produto: "Manteiga", valor: 0, quantidade: 1 },
    {
      id: 85,
      tipo: "Mercearia",
      produto: "Margarina",
    ...
    { id: 87, tipo: "Mercearia", produto: "Iorgute", valor: 0, quantidade: 1 },
    { id: 88, tipo: "Temperos", produto: "Alho", valor: 0, quantidade: 1 },
    { id: 89, tipo: "Temperos", produto: "Cebola", valor: 0, quantidade: 1 },
    { id: 90, tipo: "Temperos", produto: "Salsinha", valor: 0, quantidade: 1 },
    { id: 91, tipo: "Temperos", produto: "Cebolinha", valor: 0, quantidade: 1 },
    { id: 92, tipo: "Temperos", produto: "Orégano", valor: 0, quantidade: 1 },
    { id: 93, tipo: "Temperos", produto: "Páprica", valor: 0, quantidade: 1 },
    { id: 94, tipo: "Temperos", produto: "Cominho", valor: 0, quantidade: 1 },
    { id: 95, tipo: "Temperos", produto: "Cúrcuma", valor: 0, quantidade: 1 },
    { id: 96, tipo: "Temperos", produto: "Erva-Doce", valor: 0, quantidade: 1 },
    { id: 97, tipo: "Temperos", produto: "Canela", valor: 0, quantidade: 1 },
  ]);
